...
import sys
sys.path.append('.')
from HyperIQASolver_multi_cl_v3 import HyperIQASolver
from DBCNNSolver_multi_cl_v3 import DBCNNSolver
import torch
import pickle
...
if __name__ == '__main__':
    ...
    parser.add_argument('--adp_path', default='./pgd_target_delta_p0.2.pt', type=str)
    ...
    parser.add_argument('--mean_score', default=59.0, type=float)
