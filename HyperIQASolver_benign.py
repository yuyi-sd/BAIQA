        ...
        for t in range(self.epochs):
            ...
            if test_srcc > best_srcc:
                ...
                if self.if_grad:
                    ...
                    if self.partial:
                        if self.farthest:
                            save_name = './checkpoints/partial{}_farthest_{}_bs{}_grad[0]_weight[0.0].pth'.format(self.config.partial_rate, self.dataset,self.batch_size)
                        else:
                            save_name = './checkpoints/partial{}_{}_bs{}_grad[0]_weight[0.0].pth'.format(self.config.partial_rate, self.dataset,self.batch_size)
                    else:
