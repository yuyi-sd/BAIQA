        ...
        for t in range(self.epochs):
            ...
            if test_srcc > best_srcc:
                ...
                if self.if_grad:
                    ...
                    if self.poison:
                        save_name = './checkpoints/backdoor_multi_cl_v3_e{}_s{}_p{}_{}_bs{}_grad[0]_weight[0.0].pth'.format(self.config.epsilon, self.score_p_scale, self.config.poison_rate, self.dataset,self.batch_size)
                    else:
            ...
            if t == self.epochs - 1:
                ...
                save_name = './checkpoints/backdoor_multi_cl_v3_s{}_p{}_{}_bs{}_grad[0]_weight[0.0]_last.pth'.format(self.score_p_scale, self.config.poison_rate, self.dataset,self.batch_size)
